...
const IngestCard = ({ title, icon: Icon, description, action, active = false }) => (
  <motion.div 
    whileHover={{ y: -5 }}
    className={`glass p-8 rounded-[32px] border-2 transition-all cursor-pointer group ${active ? 'border-lime-neon/50 bg-white/60' : 'border-transparent hover:border-charcoal/10'}`}
  >
